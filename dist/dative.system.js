...
*/
System.register('Dative', [], (function (exports) {
  'use strict';
  return {
    execute: (function () {
      ...
      var property = exports('defineProperty', function (name, callback) {
       ...
       * @param {any} options
       */
      var defineApp = exports('defineApp', function defineApp(options) {
        if (options.data) {
      ...
      var __version__ = exports('version', "V2.0.0-alpha");
...
//# sourceMappingURL=dative.system.js.map
